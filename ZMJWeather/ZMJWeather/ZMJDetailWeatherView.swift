...
class ZMJDetailWeatherView: UIScrollView {
    ...
    var localityLabel: UILabel = UILabel()
    var subLocalityLabel: UILabel = UILabel()
    ...
    private func initSubViews() {
        ...
        localityLabel.font = UIFont.systemFont(ofSize: 17.0)
        localityLabel.text = ""
        localityLabel.textAlignment = NSTextAlignment.center
        self.addSubview(localityLabel)
        ...
        subLocalityLabel.textColor = UIColor.white
        subLocalityLabel.font = UIFont.systemFont(ofSize: 13.0)
        subLocalityLabel.text = ""
        subLocalityLabel.textAlignment = NSTextAlignment.center
        self.addSubview(subLocalityLabel)
        subLocalityLabel.snp.makeConstraints { (make) in
            make.centerX.equalToSuperview()
            make.top.equalTo(localityLabel.snp.bottom).offset(5.0)
            make.width.equalToSuperview()
        }
